...
contract Airline {
    ...
    constructor() {
        ...
        flights.push(Flight('Dubai', 3 ether));     
    }
    ...
    function buyFlight(uint flightIndex) public payable {
        ...
        customerTotalFlights[msg.sender] ++; //Al ser un mapping de address a un nro entero, al monento de hacer customerTotalFlights[msg.sender] se accede a un numero y se puede incrementar de esta forma
